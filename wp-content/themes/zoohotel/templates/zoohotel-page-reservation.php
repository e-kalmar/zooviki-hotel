...
<div class="container zoo-hotel-pricing-page">
  <div class="content-wrap shadow-lg p-3 mb-5 rounded">
    <div class="row justify-content-center">
      <h2 class="text-center text-success" style="font-family: 'Poppins', sans-serif;">Изберете стая за вашето куче!</h2>
    ...
    <div class="col-md-6 col-md-offset-3 modal-wrapper reservation-modal">
      <form id="booking-handler-form" class="class-booking-handler-form">
        ...
        <fieldset class="rounded overflow-none" id="fs-1">
          ...
          <input type="text" name="checkin-date" class="start rounded form-control-lg" readonly placeholder="Дата на настаняване" id="pricing-form-date-1">
        ...
        <fieldset class="rounded overflow-auto" id="fs-2">
          ...
          <input type="text" id="first-name" name="first-name" class="rounded form-control-lg" placeholder="Име" />

          <p class="validate-text text-danger validate-last-name">Моля въведете вашата фамилия.</p>
          <input type="text" id="last-name" name="last-name" class="rounded form-control-lg" placeholder="Фамилия" />
          ...
          <input type="text" id="pet-name" name="pet-name" class="rounded form-control-lg" placeholder="Име на вашият домашен любимец" />

          <p class="validate-text text-danger validate-pet-type-empty">Моля въведете порода на вашият домашен любимец.
          </p>
          <input type="text" id="pet-type" class="rounded form-control-lg" name="pet-type" placeholder="Порода" />
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td><span class="last-name"></span></td>
                  <td><span class="client-phone"></span></td>
                  <td><span class="client-address"></span></td>
                </tr>
              </tbody>
            </table>
          </div>
